    ...
    const tips = [
        {
            ...
            content: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi, corrupti.',
        ...
        <section id='tips' className="scroll-mt-20 max-w-6xl mx-auto px-4 py-12">
            <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus deleniti accusantium labore eos incidunt exercitationem quod.
                </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-sky-50 to-blue-100 rounded-2xl p-8 shadow-sm">
                <div className="flex flex-col md:flex-row items-center gap-6">
                    <div className="flex-shrink-0 bg-whtie p-6 rounded-xl shadow-md">
                        {tips[activeTip].icon}
                    </div>
                    <div>
